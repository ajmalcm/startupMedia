...
const StartupFrom = () => {
    ...
    const [state,formActio,isPending]=useActionState(handleFormSubmit,{error:"",status:"INITIAL"});
  ...
  return (
    <form action={()=>{}} className='startup-form'>
        ...
        <div>
            ...
            <Input id='category' name='category' className='startup-form_input' required placeholder='Startup Category (Text, Health, Educational...)'/>
            {
